...
class Trader:
    ...
    def calculate_sharpe_ratio(self, n_years, n_days, ret):
        ...
        """
        rf = {2018: 0.0291, 2019: 0.0214, 2020: 0.0089, 2021: 0.0145, 2022: 0.0295}
    ...
    def calculate_maximum_drawdown(self, account_balance, plot_title):
        """
    ...
    def calculate_metrics(self, cum_returns, n_years):
        ...
        print(f"Annual ROI: {avg_annual_roi}%")
    ...
    def summarize_results(self, sharpe_results, cum_returns, performance, total_pairs, ticker_segment_dict, n_years, plot_title):
        """
        ...
        max_dd, max_dd_duration, total_dd_duration = self.calculate_maximum_drawdown(total_account_balance, plot_title)
